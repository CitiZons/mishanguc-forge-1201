...
public final class HungSignBlocks extends MishangucBlocks {
  ...
  @ApiStatus.AvailableSince("1.2.4")
  public static final HungSignBlock STRIPPED_MANGROVE_WOOD_HUNG_SIGN = new HungSignBlock(Blocks.STRIPPED_MANGROVE_WOOD, BlockBehaviour.Properties.copy(Blocks.STRIPPED_MANGROVE_WOOD).mapColor(MapColor.COLOR_RED));
  @ApiStatus.AvailableSince("0.1.7")
  ...
  public static final HungSignBlock BAMBOO_HUNG_SIGN = new HungSignBlock(Blocks.BAMBOO_BLOCK, BlockBehaviour.Properties.copy(Blocks.BAMBOO_BLOCK).mapColor(MapColor.PLANT));
  @ApiStatus.AvailableSince("1.0.4-mc1.19.3")
  @MiningLevel(MiningLevel.Tool.AXE)
  public static final HungSignBlock BAMBOO_PLANK_HUNG_SIGN = new HungSignBlock(Blocks.BAMBOO_PLANKS, BlockBehaviour.Properties.copy(Blocks.BAMBOO_PLANKS));
  @ApiStatus.AvailableSince("1.0.4-mc1.19.3")
  @MiningLevel(MiningLevel.Tool.AXE)
  public static final HungSignBlock BAMBOO_MOSAIC_HUNG_SIGN = new HungSignBlock(Blocks.BAMBOO_MOSAIC, BlockBehaviour.Properties.copy(Blocks.BAMBOO_MOSAIC));
  ...
  @ApiStatus.AvailableSince("1.2.4")
  public static final HungSignBarBlock STRIPPED_MANGROVE_HUNG_SIGN_BAR = new HungSignBarBlock(Blocks.STRIPPED_MANGROVE_WOOD, BlockBehaviour.Properties.copy(Blocks.STRIPPED_MANGROVE_WOOD).mapColor(MapColor.COLOR_RED));
  @ApiStatus.AvailableSince("1.2.4")
  ...
  @ApiStatus.AvailableSince("1.0.4-mc1.19.3")
  @MiningLevel(MiningLevel.Tool.AXE)
  public static final HungSignBarBlock BAMBOO_HUNG_SIGN_BAR = new HungSignBarBlock(Blocks.BAMBOO_BLOCK, BlockBehaviour.Properties.copy(Blocks.BAMBOO_BLOCK).mapColor(Blocks.BAMBOO_BLOCK.defaultMapColor()));

  static {
    OAK_WOOD_HUNG_SIGN.baseTexture = OAK_WOOD_HUNG_SIGN.barTexture = OAK_HUNG_SIGN.barTexture = new ResourceLocation("block/oak_log");
    SPRUCE_WOOD_HUNG_SIGN.baseTexture = SPRUCE_WOOD_HUNG_SIGN.barTexture = SPRUCE_HUNG_SIGN.barTexture = new ResourceLocation("block/spruce_log");
    BIRCH_WOOD_HUNG_SIGN.baseTexture = BIRCH_WOOD_HUNG_SIGN.barTexture = BIRCH_HUNG_SIGN.barTexture = new ResourceLocation("block/birch_log");
    JUNGLE_WOOD_HUNG_SIGN.baseTexture = JUNGLE_WOOD_HUNG_SIGN.barTexture = JUNGLE_HUNG_SIGN.barTexture = new ResourceLocation("block/jungle_log");
    ACACIA_WOOD_HUNG_SIGN.baseTexture = ACACIA_WOOD_HUNG_SIGN.barTexture = ACACIA_HUNG_SIGN.barTexture = new ResourceLocation("block/acacia_log");
    CHERRY_WOOD_HUNG_SIGN.baseTexture = CHERRY_WOOD_HUNG_SIGN.barTexture = CHERRY_HUNG_SIGN.barTexture = new ResourceLocation("block/cherry_log");
    DARK_OAK_WOOD_HUNG_SIGN.baseTexture = DARK_OAK_WOOD_HUNG_SIGN.barTexture = DARK_OAK_HUNG_SIGN.barTexture = new ResourceLocation("block/dark_oak_log");
    MANGROVE_WOOD_HUNG_SIGN.baseTexture = MANGROVE_WOOD_HUNG_SIGN.barTexture = MANGROVE_HUNG_SIGN.barTexture = new ResourceLocation("block/mangrove_log");
    CRIMSON_HYPHAE_HUNG_SIGN.baseTexture = CRIMSON_HYPHAE_HUNG_SIGN.barTexture = CRIMSON_HUNG_SIGN.barTexture = new ResourceLocation("block/crimson_stem");
    WARPED_HYPHAE_HUNG_SIGN.baseTexture = WARPED_HYPHAE_HUNG_SIGN.barTexture = WARPED_HUNG_SIGN.barTexture = new ResourceLocation("block/warped_stem");
    STRIPPED_OAK_WOOD_HUNG_SIGN.baseTexture = new ResourceLocation("block/stripped_oak_log");
    STRIPPED_SPRUCE_WOOD_HUNG_SIGN.baseTexture = new ResourceLocation("block/stripped_spruce_log");
    STRIPPED_BIRCH_WOOD_HUNG_SIGN.baseTexture = new ResourceLocation("block/stripped_birch_log");
    STRIPPED_JUNGLE_WOOD_HUNG_SIGN.baseTexture = new ResourceLocation("block/stripped_jungle_log");
    STRIPPED_ACACIA_WOOD_HUNG_SIGN.baseTexture = new ResourceLocation("block/stripped_acacia_log");
    STRIPPED_CHERRY_WOOD_HUNG_SIGN.baseTexture = new ResourceLocation("block/stripped_cherry_log");
    STRIPPED_DARK_OAK_WOOD_HUNG_SIGN.baseTexture = new ResourceLocation("block/stripped_dark_oak_log");
    STRIPPED_MANGROVE_WOOD_HUNG_SIGN.baseTexture = new ResourceLocation("block/stripped_mangrove_log");
    STRIPPED_CRIMSON_HYPHAE_HUNG_SIGN.baseTexture = new ResourceLocation("block/stripped_crimson_stem");
    STRIPPED_WARPED_HYPHAE_HUNG_SIGN.baseTexture = new ResourceLocation("block/stripped_warped_stem");
    OAK_HUNG_SIGN.textureTop = new ResourceLocation("block/oak_log");
    SPRUCE_HUNG_SIGN.textureTop = new ResourceLocation("block/spruce_log");
    BIRCH_HUNG_SIGN.textureTop = new ResourceLocation("block/birch_log");
    JUNGLE_HUNG_SIGN.textureTop = new ResourceLocation("block/jungle_log");
    ACACIA_HUNG_SIGN.textureTop = new ResourceLocation("block/acacia_log");
    CHERRY_HUNG_SIGN.textureTop = new ResourceLocation("block/cherry_log");
    DARK_OAK_HUNG_SIGN.textureTop = new ResourceLocation("block/dark_oak_log");
    MANGROVE_HUNG_SIGN.textureTop = new ResourceLocation("block/mangrove_log");
    CRIMSON_HUNG_SIGN.textureTop = new ResourceLocation("block/crimson_stem");
    WARPED_HUNG_SIGN.textureTop = new ResourceLocation("block/warped_stem");
    OAK_HUNG_SIGN_BAR.texture = new ResourceLocation("block/oak_log");
    SPRUCE_HUNG_SIGN_BAR.texture = new ResourceLocation("block/spruce_log");
    BIRCH_HUNG_SIGN_BAR.texture = new ResourceLocation("block/birch_log");
    JUNGLE_HUNG_SIGN_BAR.texture = new ResourceLocation("block/jungle_log");
    ACACIA_HUNG_SIGN_BAR.texture = new ResourceLocation("block/acacia_log");
    CHERRY_HUNG_SIGN_BAR.texture = new ResourceLocation("block/cherry_log");
    DARK_OAK_HUNG_SIGN_BAR.texture = new ResourceLocation("block/dark_oak_log");
    MANGROVE_HUNG_SIGN_BAR.texture = new ResourceLocation("block/mangrove_log");
    CRIMSON_HUNG_SIGN_BAR.texture = new ResourceLocation("block/crimson_stem");
    WARPED_HUNG_SIGN_BAR.texture = new ResourceLocation("block/warped_stem");
    STRIPPED_OAK_HUNG_SIGN_BAR.texture = new ResourceLocation("block/stripped_oak_log");
    STRIPPED_SPRUCE_HUNG_SIGN_BAR.texture = new ResourceLocation("block/stripped_spruce_log");
    STRIPPED_BIRCH_HUNG_SIGN_BAR.texture = new ResourceLocation("block/stripped_birch_log");
    STRIPPED_JUNGLE_HUNG_SIGN_BAR.texture = new ResourceLocation("block/stripped_jungle_log");
    STRIPPED_ACACIA_HUNG_SIGN_BAR.texture = new ResourceLocation("block/stripped_acacia_log");
    STRIPPED_CHERRY_HUNG_SIGN_BAR.texture = new ResourceLocation("block/stripped_cherry_log");
    STRIPPED_DARK_OAK_HUNG_SIGN_BAR.texture = new ResourceLocation("block/stripped_dark_oak_log");
    STRIPPED_MANGROVE_HUNG_SIGN_BAR.texture = new ResourceLocation("block/stripped_mangrove_log");
    STRIPPED_CRIMSON_HUNG_SIGN_BAR.texture = new ResourceLocation("block/stripped_crimson_stem");
    STRIPPED_WARPED_HUNG_SIGN_BAR.texture = new ResourceLocation("block/stripped_warped_stem");
    BAMBOO_HUNG_SIGN.barTexture = BAMBOO_HUNG_SIGN.textureTop = BAMBOO_PLANK_HUNG_SIGN.barTexture = BAMBOO_PLANK_HUNG_SIGN.textureTop = BAMBOO_MOSAIC_HUNG_SIGN.barTexture = BAMBOO_MOSAIC_HUNG_SIGN.textureTop = BAMBOO_HUNG_SIGN_BAR.texture = new ResourceLocation("block/bamboo_block");
  }
  ...
  static {
    GLOWING_NETHERRACK_HUNG_SIGN.glowTexture = new ResourceLocation("block/lava_still");
    GLOWING_NETHER_BRICK_HUNG_SIGN.glowTexture = new ResourceLocation("block/lava_still");
    GLOWING_BLACKSTONE_HUNG_SIGN.glowTexture = new ResourceLocation("block/glowstone");
    GLOWING_POLISHED_BLACKSTONE_HUNG_SIGN.glowTexture = new ResourceLocation("block/glowstone");
  }
  ...
  static {
    SNOW_HUNG_SIGN.baseTexture = new ResourceLocation("block/snow");
    SNOW_HUNG_SIGN.barTexture = new ResourceLocation("block/packed_ice");
    SNOW_HUNG_SIGN.textureTop = new ResourceLocation("block/packed_ice");
    GLOWING_SNOW_HUNG_SIGN.baseTexture = new ResourceLocation("block/snow");
    GLOWING_SNOW_HUNG_SIGN.barTexture = new ResourceLocation("block/packed_ice");
    GLOWING_SNOW_HUNG_SIGN.textureTop = new ResourceLocation("block/packed_ice");
    ICE_HUNG_SIGN.textureTop = ICE_HUNG_SIGN.barTexture = new ResourceLocation("block/blue_ice");
  }
