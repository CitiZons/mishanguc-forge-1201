...
public abstract class RecipeJsonBuilderMixins {
  ...
  @ModifyExpressionValue(method = "save", at = @At(value = "INVOKE", target = "Lnet/minecraft/data/recipes/RecipeCategory;getSerializedName()Ljava/lang/String;"))
  private String redirectGetCategoryName(String original) {
    final String customRecipeCategory = MishangucRecipeProvider.getCustomRecipeCategory(((RecipeBuilder) this).getResult());
